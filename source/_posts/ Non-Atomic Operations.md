...
{% asset_img nonatomic.png atomic vs non-atmoic %}
...
{% asset_img test_load_store_64_fail.png %}
...
g_wrapper;
```
{% asset_img test_load_store_32_fail.png %}
...
{% asset_img slot-machines.png mix it up %}
